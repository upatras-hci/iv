## Personal Data:
Ονοματεπώνυμο: Παναγιωτοπούλου Χρυσούλα <br /> 
ΑΜ: 1041145
...
Για τη δημιουργία του βιογραφικού μου στο μέρος Α, χρησιμοποίησα ένα πρακτικό και όμορφα σχεδιασμένο template, το jekyll-cv. Παρακάτω παραθέτω τις αλλαγές των αρχείων:<br>
...
## Βιογραφικό Β
Για το βιογραφικό Β και την παραγωγή του ζητούμενου PDF ακολούθησα τα εξής βήματα:<br>

- **έχω κάνει fork το repository του [simple-cv](https://github.com/plain-plain-text/simple-cv).<br>**
- **έχω δημιουργήσει τη δική μου σελίδα [my_simple_cv](https://xrusa-pan.github.io/simple-cv/)<br>**
...
## Γραμμές Εντολών (Custom desktop environment)
...
Στο συγκεκριμένο συμμετοχικό δεν κατάφερα να παράγω κάποιο αποτέλεσμα.

### Τελική αναφορά
Το εκπαιδευτικό υλικό που παρουσιάστηκε στα πλαίσια του μαθήματος ήταν εξαιρετικά οργανωμένο και πλήρες. Οι παρεχόμενες οδηγίες ήταν εξαιρετικά αναλυτικές, καλύπτοντας επαρκώς τις ανάγκες για όλα τα παραδοτέα του μαθήματος. Η δομή του μαθήματος συνέβαλε σημαντικά στην εξέλιξη των γνώσεών μου σχετικά με το GitHub και τις δεξιότητες μου στη χρήση των command lines και του Git.
Επιπλέον, το μάθημα αυτό διεύρυνε το πεδίο των δεξιοτήτων μου, καθώς με βοήθησε να εξερευνήσω διάφορες μεθόδους οπτικοποίησης της πληροφορίας. Η πρακτική εφαρμογή αυτών των γνώσεων με έκανε πιο αυτόνομο στην αντιμετώπιση προκλήσεων σχετικά με την ανάλυση και την παρουσίαση δεδομένων.
Συνολικά, η εμπειρία αυτού του μαθήματος συνέβαλε στο να αναπτύξω ουσιαστικά τις ικανότητές μου και να επεκτείνω το εύρος των γνώσεών μου στον χώρο της τεχνολογίας και κυρίως στην οπτικοποίηση πληροφορίας. Επιπλέον η συνεργασία μου με την ομάδα με βοήθησε να εκτιμήσω τη σημασία της συνεργατικότητας και του ομαδικού πνεύματος, καθώς βοήθησε στη διεκπεραίωση του συμμετοχικού περιεχομένου.
