...
Για το δεύτερο συμμετοχικό καταφέραμε και μας δούλεψε το deploy στο netlify με κάποια προβλήματα μεν που θα συζητήσουμε και μαζί στο μάθημα. Προσθέσαμε στους φακέλους slides και timeline από ένα αρχείο art.md με το αντίστοιχο layout του οποίο και πρόκειται να συγκεντρώνει όλες μας τις εικόνες μαζί.
