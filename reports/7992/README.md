# Μαθημα Οπτικοποιηση της πληροφοριας 2020-21
...
- [ ] προσθηκη χαρτη για την αναπαρασταση της κατανομης των εγγραφων
- [ ] κατηγοριοποιηση δεδομενων βασει φυλου
- [ ] deploy λειτουργια απο την πλευρα travis
