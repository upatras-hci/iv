...
Το περιεχόμενο των ασκήσεων βασιζόταν κυρίως στη δημιουργία και επεξεργασία αρχείων [markdown](https://www.markdownguide.org/), [yaml](https://docs.ansible.com/ansible/latest/reference_appendices/YAMLSyntax.html), [html](https://www.w3schools.com/) και [tex](https://www.latex-project.org/) μέσω του version control system του [git](https://git-scm.com/doc). Για την οπτικοποίηση των σελίδων χρησιμοποιήθηκε το [Netlify](https://www.netlify.com/) και τα [GitHub Pages](https://pages.github.com/).<br>
...
HTML https://www.w3schools.com/<br>
...
asciinema https://asciinema.org/docs/getting-started<br>
